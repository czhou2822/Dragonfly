...
namespace df 
{
    ...
    private:
        ...
        DisplayManager(DisplayManager const&) = delete;  // Don't allow copy.
        void operator=(DisplayManager const&) = delete;  // Don't allow assignment.
    ...
    public:
        ...
        inline int getHorizontal() const { return m_window_horizontal_chars; }

        // Return window's vertical maximum (in characters).
        inline int getVertical() const { return m_window_horizontal_chars; }

        // Return window's horizontal maximum (in pixels).
        inline int getHorizontalPixels() const { return m_window_horizontal_pixels; }

        // Return window's vertical maximum (in pixels).
        inline int getVerticalPixels() const { return m_window_vertical_pixels; }
        ...
        inline sf::RenderWindow* getWindow() const { return m_p_window; }
    };
